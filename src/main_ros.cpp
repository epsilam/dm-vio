...
#include "IOWrapper/OutputWrapper/ROSOutputWrapper.h"
...
double requestFullResetErrorThreshold = -1;
...
int main(int argc, char** argv)
{
    ...
    // Error threshold above which the system attempts a full reset
    settingsUtil->registerArg("requestFullResetErrorThreshold", requestFullResetErrorThreshold);
    ...
    if(rosbagFile == "")
    {
        imageSub = it.subscribe("cam0/image_raw", 3, &vidCb);
